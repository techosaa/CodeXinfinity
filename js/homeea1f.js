...
(function ($) {
  ...
  $("#fullpage").fullpage({
    ...
    scrollingSpeed: 1600,
    paddingTop: "140px",
    anchors: ['#HomePage','fette-formaggio','panna'],
    sectionSelector: "section",
    navigationTooltips: ['Menu-Sroller','Fette Formaggio','Panna'
],
...

{
  ...
  var HoverImgFx3 = /*#__PURE__*/ (function () {
    ...
    function HoverImgFx3(el) {
      ...
      this.DOM.reveal.innerHTML = '<div class="hover-reveal__inner"><div class="hover-reveal__img" style="background-image:url('.concat(
    ...
    _createClass(HoverImgFx3, [
      {
        ...
        value: function initEvents() {
          ...
          this.positionElement = function (ev) {
            ...
            _this2.DOM.reveal.style.top = "".concat(
              mousePos.y + 20 - docScrolls.top,
              "px"
            );
            _this2.DOM.reveal.style.left = "".concat(
  ...
  var HoverImgFx6 = /*#__PURE__*/ (function () {
    ...
    function HoverImgFx6(el) {
      ...
      this.DOM.reveal = document.createElement("div");
      this.DOM.reveal.className = "hover-reveal";
      this.DOM.reveal.innerHTML = '<div class="hover-reveal__deco"></div><div class="hover-reveal__inner"><div class="hover-reveal__img" style="background-image:url('.concat(
        this.DOM.el.dataset.img,
        ')"></div></div>'
      );
      this.DOM.el.appendChild(this.DOM.reveal);
    ...
    _createClass(HoverImgFx6, [
      {
        ...
        value: function initEvents() {
          ...
          this.positionElement = function (ev) {
            ...
            _this5.DOM.reveal.style.top = "".concat(
              mousePos.y + 20 - docScrolls.top,
              "px"
            );
            _this5.DOM.reveal.style.left = "".concat(
              mousePos.x - _this5.rect.width - 20 - docScrolls.left,
              "px"
            );
          };
...
}
{
  ...
  var Item = /*#__PURE__*/ (function () {
    ...
    function Item(el, options) {
      ...
      this.DOM.animatable.deco5 = this.DOM.el.querySelector(
        ".box-deco-vbottom"
      );
          ...
          this.mouseleaveFn = function (ev) {
            return requestAnimationFrame(function () {
              ...
              for (var key in _this8.DOM.animatable) {
                if (
                  _this8.DOM.animatable[key] == undefined ||
                  _this8.options[key] == undefined
                ) {
                  continue;
                }

                TweenMax.to(
                  _this8.DOM.animatable[key],
                  _this8.options[key].reverseAnimation != undefined
                    ? _this8.options[key].reverseAnimation.duration || 0
                    : 1.5,
                  {
                    ease:
                      _this8.options[key].reverseAnimation != undefined
                        ? _this8.options[key].reverseAnimation.ease ||
                          "Power2.easeOut"
                        : "Power2.easeOut",
                    x: 0,
                    y: 0,
    ...
    _createClass(Overlay, [
        ...
        value: function show(contentItem) {
          ...
          TweenMax.to(this.DOM.reveal, 0.5, {
            ...
            onComplete: function onComplete() {
              ...
              TweenMax.to(_this9.DOM.reveal, 0.5, {
                delay: 0.2,
                ease: "Power3.easeOut",
                x: "-100%",
              });
      ...
      },
      {
        ...
        value: function revealItem() {
          ...
          for (
            var _i = 0, _itemElems = itemElems;
            _i < _itemElems.length;
            _i++
          ) {
      ...
      },
      {
        ...
        value: function hide() {
          ...
          TweenMax.to(this.DOM.reveal, 0.7, {
            delay: 0.3,
            ease: "Power3.easeOut",
            x: "0%",
            onComplete: function onComplete() {
              ...
              TweenMax.to(_this10.DOM.reveal, 0.7, {
                delay: 0,
                ease: "Power3.easeOut",
                x: "100%",
              });
          ...
          for (
            var _i2 = 0, _itemElems2 = itemElems;
            _i2 < _itemElems2.length;
            _i2++
          ) {
  ...
  var Grid = /*#__PURE__*/ (function () {
    ...
    function Grid(el) {
      ...
      this.items = [];
      Array.from(this.DOM.el.querySelectorAll("a.grid-item")).forEach(function (
        item
      ) {
