...
(function($) {
    ...
    $("#fullpage").fullpage({
      ...
      scrollingSpeed: 1600,
      paddingTop: "140px",
      anchors: ["formaggio-di-capra", "gouda", "cheddar"],
    ...
    var Overlay = /*#__PURE__*/ function() {
        ...
        _createClass(Overlay, [{
            ...
            value: function show(contentItem) {
                ...
                $('.column-2').addClass("bounceIn animated has-700");
                $(".column-3").addClass("bounceIn animated has-800");
